...
FRAME_MILLIS = 20     # ms entre frames (~50 fps)

# --- Control de animación compatible con Streamlit Cloud ---
if 'frame' not in st.session_state:
    st.session_state.frame = 0

# --- Autorefresh para animación ---
if st.session_state.animando:
    st_autorefresh(interval=FRAME_MILLIS, key="refresh")
...
# --- Requisitos para Streamlit Cloud ---
# Asegúrate de que streamlit-autorefresh esté en requirements.txt