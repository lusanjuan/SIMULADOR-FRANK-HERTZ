...
fig.patch.set_facecolor('#0d1c2c')
canvas = st.empty()
...
ELECTRON_SIZE = 14  # ligeramente más pequeño para distinguir mejor

# --- OPTIMIZACIÓN: parámetros de eficiencia ---
MAX_ELECTRONES = 180  # más electrones activos para mayor visibilidad
# Eliminamos DRAW_EVERY_N y FRAME_INTERVAL para dibujar en cada frame

# Ajuste de dt para mayor suavidad
DT_ANIM = 0.04
